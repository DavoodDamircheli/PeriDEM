...
- **Robert P. Lipton** –  modeling and algorithm design
- **Debdeep Bhattacharya** – developer, initiated the project, developed the original 2D simulation code, and designed the architecture for the 3D extension.
