...
delta = 1.0*rad/args.delta_factor
meshsize = rad/mf
...
x_max = L
y_max = Ly
z_max = Lz -0* contact_radius
wall = Wall3d(1, x_min, y_min, z_min, x_max, y_max, z_max)


SL = ShapeList()

shape=shape_dict.sphere(rad=radi, meshsize=meshsize)

#material = material_dict.ottawa_sand_old2(delta)
material = material_dict.ottawa_sand_1(delta)
material.print()

normal_stiffness = material_dict.ottawa_sand_1(contact_radius).cnot / contact_radius
