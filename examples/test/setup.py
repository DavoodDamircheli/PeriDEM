...
from exp_dict import ShapeList, Wall3d,CylinderWall3d, Contact, Experiment, plot3d_setup_v2
...
def main():
    ...
    # CYLINDER (new)
    wall = CylinderWall3d(
    allow=0.0, xc=0.0, yc=0.0,
    z_min=0.0, z_max=9e-3,
    radius=2e-3,
    speed_bottom=0.0, speed_top=-1e-6, speed_side=0.0
)
    ...
    if args.plot:
        ...
        plot3d_setup_v2(particles, dotsize=15, wall=wall, show_particle_index=True,
