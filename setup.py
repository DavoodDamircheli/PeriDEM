...
delta_factor       = getattr(args, "delta_factor", 3.015)
contact_rad_factor = getattr(args, "contact_rad_factor", 5.0)
...
surf_gap = 0.01 * rad                   # surface-to-surface clearance between neighboring grains
wall_gap = 0.5 * surf_gap                         # clearance from wall surface to grain surface
...
for i in range(count):
    ...
    part.acc += gvec
    part.extforce+=[0,0,gval * part.material.rho] 
